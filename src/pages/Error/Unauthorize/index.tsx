...
const Unauthorize = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen bg-gray-100">
      <div className="flex flex-col text-gray-700 lg:flex-row lg:space-x-16 lg:space-x-reverse lg:items-center">
        <div className="order-1 max-w-md px-2 text-sm md:text-base lg:px-0">
          ...
          <p className="md:text-lg max-w-sm leading-5 md:leading-7 mt-2">
